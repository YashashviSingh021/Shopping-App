...
class Profile6 extends StatelessWidget {
  ...
  Widget _buildMainInfo(BuildContext context,double width){
    ...
    return Container(
      ...
      child: Column(
        children: <Widget>[
          Text('Your Account',style: TextStyle(fontSize: 20,color: Colors.blue,fontWeight: FontWeight.bold)),
          SizedBox(height: 10),
           Text('Name',style: TextStyle(fontSize: 20,color: Colors.blue,fontWeight: FontWeight.bold)),
